...
const buttonVariants = (props?: { variant?: ButtonProps["variant"]; size?: ButtonProps["size"] }) => {
  ...
  const baseClasses = "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors";
  ...
  return cn(baseClasses, focusClasses, disabledClasses, iconClasses, variantClasses, sizeClasses);
};
